# Generated by Powerlevel10k configuration wizard on 2022-02-03 at 14:02 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_{LEFT,RIGHT}_LEFT_WHITESPACE="%k%F{$POWERLEVEL9K_BACKGROUND}\uE0B6%s"
  typeset -g POWERLEVEL9K_{LEFT,RIGHT}_RIGHT_WHITESPACE="%k%F{$POWERLEVEL9K_BACKGROUND}\uE0B4%s"
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${clean}${(g::)POWERLEVEL9K_VCS_BEHIND_ICON}${VCS_STATUS_COMMITS_BEHIND}"
    # >42 if ahead of the remote; no leading space if also behind the remote: <42>42.
    (( VCS_STATUS_COMMITS_AHEAD && !VCS_STATUS_COMMITS_BEHIND )) && res+=" "
    (( VCS_STATUS_COMMITS_AHEAD  )) && res+="${clean}${(g::)POWERLEVEL9K_VCS_AHEAD_ICON}${VCS_STATUS_COMMITS_AHEAD}"
